...
function FeedbackCard({ comment, rating, contentQuality, pacing, date }: CardProps) {
  ...
  return (
    <Card className="mb-3 shadow-sm p-0">
      ...
      <Card.Footer className="text-muted small">{new Date(date).toLocaleDateString()}</Card.Footer>
    </Card>
  );
}
